...
with renewable as (
    ...
    from {{ ref('bi_annual_energy_renewable_sources') }}
...
non_renewable as (
    ...
    from {{ ref('bi_annual_energy_non_renewable_sources') }}
...
combined as (
    ...
    select
        ...
        coalesce(r.semester, n.semester) as semester,
